...
static void NotifyzSVGReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzSVGReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzSVGReset.connect(boost::bind(NotifyzSVGReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzSVGReset.disconnect(boost::bind(NotifyzSVGReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zsvgTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus);
}
